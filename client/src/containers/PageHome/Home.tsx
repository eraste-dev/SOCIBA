...
export const LIST_GRID_CLASS: string = 'grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-4';
export const LIST_RELATED_GRID_CLASS: string = 'grid-cols-6';
  ...
  return (
    <div className={`nc-PageHomeDemo3 overflow-hidden relative ` + BG_BACKGROUND}>
      ...
      <div className="container relative">
        ...
        {true ? (
          <SectionSliderCitiesTwo className="mb-3" categoryCardType="card1" sliderStype="style1" heading=" " subHeading="Ou souhaitez-vous trouver votre logement ?" />
        ) : (
          <SectionSliderCities className="mb-3" categoryCardType="card1" sliderStype="style1" heading=" " subHeading="Ou souhaitez-vous trouver votre logement ?" uniqueSliderClass="slider-top" />
        )}
        ...
        {/* === SECTION TOP POSTS === */}
        <SectionSliderPosts className="pt-1 pb-3 my-0" postCardName="card11" heading="Les plus récentes" subHeading="" uniqueSliderClass="slider-top" />
        {/* === SECTION TOP POSTS === */}
