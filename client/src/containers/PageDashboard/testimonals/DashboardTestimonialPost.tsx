...
import { fetchTestimonal } from "app/axios/actions/api.testimony";
import TestimonalForm from "./TestimonalForm";

export type VIEW_ADMIN_POST_CATEGORY = "LIST" | "EDIT";

const DashboardTestimonialPost = () => {
    ...
    const handleRefresh = () => {
        return dispatch(fetchTestimonal());
    };
...
export default DashboardTestimonialPost;
