  ...
  return (
    <>
      ...
      <form className="relative w-full mt-3  dark:bg-neutral-900 sm:bg-white p-1 " onSubmit={handleSubmit(onSubmit)}>
        ...
        />
        <button type="submit" className="absolute top-1/2 -translate-y-1/2 right-3 text-neutral-500 cursor-pointer">
      ...
      {open && (
        ...
        >
          ...
          {searchText == '' && <div className="w-full flex justify-center text-sm text-neutral-200 dark:text-neutral-800"> Aucun résultat </div>}
