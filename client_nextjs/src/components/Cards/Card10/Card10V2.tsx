...
import PostCardMetaV2 from "components/PostCard/PostCardMeta/PostCardMetaV2";
	...
	return (
		...
		>
			<div className="block group rounded-3xl flex-shrink-0 relative w-full aspect-w-16 aspect-h-12 sm:aspect-h-9 overflow-hidden ">
				<div>{/* <PostFeaturedMedia post={post} isHover={isHover} /> */}</div>

				<Link to={href} className="absolute inset-0 bg-neutral-900 bg-opacity-20 opacity-0 transition-opacity"></Link>
			</div>
