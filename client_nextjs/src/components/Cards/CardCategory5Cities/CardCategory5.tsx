...
export interface CardCategoryCities5Props {
	className?: string;
	taxonomy: ILocation;
}

const CardCategoryCities5: FC<CardCategoryCities5Props> = ({ className = "", taxonomy }) => {
	const { count_post, name, href = "/", thumbnail } = taxonomy;
...
export default CardCategoryCities5;
