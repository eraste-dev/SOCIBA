...
const Card11_2: FC<Card11_2Props> = ({
	className = "h-full",
	post,
	hiddenAuthor = false,
	...
	return (
		<div
			className={`nc-Card11_2 relative flex flex-col group [ nc-box-has-hover ] [ nc-dark-box-bg-has-hover ] ${className}`}
			data-nc-id="Card11_2"
