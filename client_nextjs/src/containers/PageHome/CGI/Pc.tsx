			...
			<div className="space-y-6 text-justify leading-relaxed">
				...
				<section>
					...
					<ul className="list-disc ml-6">
						<li>Données d'identification : Nom, prénom, adresse e-mail, numéro de téléphone, etc.</li>
						<li>Données relatives aux transactions : Informations liées à vos demandes ou vos achats (par exemple, demande d'informations sur un bien immobilier).</li>
						<li>Données de navigation : Adresse IP, type de navigateur, historique de navigation sur notre site, etc.</li>
						<li>Autres données : Toute autre information que vous nous fournissez directement via des formulaires de contact ou de demande de services.</li>
					</ul>
				</section>
				...
				<section>
					...
					<ul className="list-disc ml-6">
						<li>Gestion des demandes : Répondre à vos demandes de renseignements, vous proposer des biens immobiliers correspondant à vos critères.</li>
						<li>Amélioration du site : Analyser la fréquentation du site et améliorer l'expérience utilisateur.</li>
						<li>Marketing : Vous envoyer des offres commerciales si vous avez donné votre consentement.</li>
						<li>Conformité légale : Respecter nos obligations légales et réglementaires.</li>
					</ul>
				</section>
				...
				<section>
					...
					<ul className="list-disc ml-6">
						<li>Consentement : Lorsque vous nous avez donné votre consentement explicite pour l'envoi de communications marketing.</li>
						<li>Exécution d'un contrat : Lorsque le traitement est nécessaire à l'exécution d'un contrat auquel vous êtes partie, par exemple dans le cadre d'une demande d'achat ou de location.</li>
						<li>Intérêt légitime : Pour améliorer nos services ou protéger la sécurité de nos systèmes informatiques.</li>
						<li>Obligations légales : Pour répondre à des obligations légales et réglementaires.</li>
					</ul>
				</section>
				...
				<section>
					...
					<ul className="list-disc ml-6">
						<li>Fournisseurs de services : Nous pouvons partager vos données avec des prestataires de services de confiance pour traiter vos demandes ou réaliser certaines opérations (par exemple, hébergement de données, support technique).</li>
						<li>Obligations légales : Si cela est requis par la loi ou pour protéger nos droits et intérêts légitimes (par exemple, en cas de fraude ou de litige).</li>
					</ul>
				</section>
				...
				<section>
					...
					<ul className="list-disc ml-6">
						<li>Données de contact : conservées pendant 5 ans après votre dernière interaction avec notre site.</li>
						<li>Données de transaction : conservées pendant plus de 13 mois conformément aux obligations légales en matière comptable ou fiscale.</li>
					</ul>
				</section>
				...
				<section>
					...
					<ul className="list-disc ml-6">
						<li>Droit d’accès : Vous avez le droit de demander l’accès à vos données personnelles.</li>
						...
						<li>Droit à la limitation du traitement : Vous pouvez demander de restreindre l’utilisation de vos données.</li>
						<li>Droit à la portabilité : Vous pouvez demander à recevoir vos données dans un format structuré et couramment utilisé.</li>
