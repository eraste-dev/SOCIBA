	...
	return (
		<div className="max-w-4xl mx-auto p-6">
			...
			<div className="space-y-6 text-justify leading-relaxed">
				...
				<section>
					<h2 className="text-lg font-semibold mb-2">2. Objet du Site</h2>
					<p>
				...
				<section>
					<h2 className="text-lg font-semibold mb-2">4. Inscription et Compte Utilisateur</h2>
					<p>
				...
				<section>
					<h2 className="text-lg font-semibold mb-2">5. Protection des Données Personnelles</h2>
					<p>
				...
				<section>
					<h2 className="text-lg font-semibold mb-2">6. Propriété Intellectuelle</h2>
					<p>
				...
				<section>
					<h2 className="text-lg font-semibold mb-2">7. Utilisation du Site</h2>
					<p>
				...
				<section>
					<h2 className="text-lg font-semibold mb-2">9. Liens Externes</h2>
					<p>
				...
				<section>
					<h2 className="text-lg font-semibold mb-2">11. Droit Applicable et Juridiction</h2>
					<p>
				...
				<section>
					...
					<p>
						...
						<a href="mailto:bajorahimmobilier@gmail.com" className="text-blue-500 underline">bajorahimmobilier@gmail.com</a>.
					</p>
				</section>
			</div>
		</div>
