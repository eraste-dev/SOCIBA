											...
											<div>
												<label className="block md:col-span-2">
													...
													<Input
														...
														className="mt-1"
														defaultValue={
															product && product.location_description
														}
										...
										<>
											...
											<label className="block md:col-span-2">
												...
												<p className="mt-1 text-sm text-neutral-500">
													...
													article. N’indiquez pas vos coordonnées (e-mail,
													téléphones, …) dans la description.
												</p>
												{watch("excerpt") && (
													<span
														className={
