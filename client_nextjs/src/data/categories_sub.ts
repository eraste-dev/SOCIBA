...
export const CATEGORIES_SUB: IPropertySubCategory[] = [
	...
	{ id: 8, name: "Chambre", allow: [HOTEL_KEY], uuid: "CHAMBRE" },
	{ id: 9, name: "Suite", allow: [HOTEL_KEY], uuid: "SUITE" },
	{ id: 999, name: "Autre", allow: [APPARTEMENT_KEY], uuid: "AUTRE" },
];
